...
class Main:
    ...
    def env(self):
        list_env = ['.env.bak', '.env', 'core/.env', 'public/.env', 'app/.env', 'laravel/core/.env', 'beta/.env', 'config/.env', 'kyc/.env', 'admin/.env', 'prod/.env', 'api/.env', 'tokenlite_app/.env', 'backend/.env', 'env.backup', '.environment', '.envrc', '.envs', '.env~']
